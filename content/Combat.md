...
Dans Negotium, les tours se font dans cet ordre.

1. Le(s) Boss.
2. Les joueurs.
3. Les adversaires.
4. Les PNJs Neutre/alliés.
...
- **Ajouter un effet de l’arme dans l’attaque.** Voir les caractéristiques de l'arme.
- **Lancer un sort** si celui possède des capacités en petites actions.
- **Boire une potion.**

De même, le joueur peut reporter sa petite action avec un point de réaction. De plus, il peut convertir une petite action en une petite action.
...
- **Esquiver.** Le personnage tente d’esquiver un coup qu’il voit. L’attaquant et la cible font chacun un jet de mêlée/visée (en fonction du type d’attaque). Si jamais l’attaquant a un score supérieur ou égale à la cible, celle-ci touche.
...
Quand un personnage n’est pas satisfait de l’existence de la créature en face de lui, il va vouloir effectuer une action belliqueuse à son égard. En général, cela se fait par l’action d’attaquer en utilisant ses poings, pieds, une arme ou un sort.

Tout d’abord, l’attaque doit déclarer sa cible et le moyen utilisé. Si jamais elle voit l’attaque, la cible peut utiliser une réaction pour tenter de l’esquiver. Dans ce cas, les deux vont faire un jet (Contact ou Distance)+(Corps/Mental) (en fonction du type d'attaque). Si l’attaquant a un nombre de réussites supérieur ou égal que son adversaire, il touche et peut infliger ses dégâts.

Les dégâts dépendent directement aux caractéristiques de l’arme qu’il utilise. Il lance l'ensemble des dégâts de l'arme, et additionne le résultat.
La plupart des combattants possèdent des moyens pour se protéger des coups (Armure, bouclier, sorts…), ce qui va réduire les dégâts subits. Celle-ci apporte des points d’armure. Les dégâts seront réduits du nombre de points d’armure.
...
- 1 points pour relancer un dé de son choix (dégât ou jet de caractéristique)
...
\*Vous ne pouvez qu'activer cette capacité qu'une seule fois par tour.

## Exemples de scène de combat

_Johan tente de tire à l’Arc sur la guerrière Maria. Cette dernière le voit venir et tente d’esquiver le coup en dépensant une réaction. Johan et Maria lancent tous deux un jet de Distance+Corps. Johan lance 8d6 (3 en distance et 5 corps) et obtient 4 réussites. Maria lance 6d6 et obtient, elle aussi, 4 réussites. Johan réussit à la toucher et peut faire ses dégâts._ 
*Il lance 3d6 et additionne le tout, ce qui donne 8. Maria porte une armure avec 1 points d’armure, réduisant les dégâts subits à 7.*

  
*Isa donne un coup avec une hache à une main derrière le dos d’un garde en combat contre un autre adversaire. Le garde, n’ayant pas vu Isa derrière elle, ne peut pas faire utiliser de réaction pour esquiver. Il se prend donc directement les dégâts. Isa lance 3d6, mais décide d'utiliser sa petite action pour rajouter l'effet "frappe", la permettant de relancer les dés de dégâts qu'elle souhaite. Son premier jet est 2,3,5. Elle décide de relancer le 2 et le 3, elle obtient 1,4,5. Voulant maximiser ses dégâts, elle dépense un point de malfaisance pour relancer le 1. Elle obtient 6,4,5, ce qui fait un total de 15 dégâts. Le garde portant une Armure lourde, avec 3 points d'armures, il prend 12 points de dégâts au total.*
*Isa voulant achever son adversaire, décide de dépenser 10 points de malfaisance pour avoir une grande action supplémentaire. Elle bénéficie encore de son effet de surprise, et donc n'a pas besoin de lancer un jet de Corps/Contact. Comme dégât, elle obtient 1,3,4=8. Cela suffit pour achever le garde.*
